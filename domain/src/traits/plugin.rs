//! Generic plugin slot for the pingle daemon.
//!
...
/// adapters that wrap a wasm guest loaded by `plugin-extism` and
/// translate trait calls into wasm exports. See
/// `plugin_extism::plugin_adapter::PluginAdapter` for the canonical
/// implementation.
///
...
pub trait Plugin: Send + Sync {
    ...
    /// `daemon.info` IPC method so clients can show "auth: pingle-hub"
